...
import type { TransferCustomListBodyProps, TransferListProps } from 'antd/lib/transfer/list';
export type { TransferListProps } from 'antd/lib/transfer/list';
export type { TransferOperationProps } from 'antd/lib/transfer/operation';
...
declare const Transfer: {
    ...
    Operation: React.FC<import("antd/lib/transfer/operation").TransferOperationProps>;
};
