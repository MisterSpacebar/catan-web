...
import type { FootnoteBackContentTemplate } from 'mdast-util-to-hast/lib/footer.js';
import type { FootnoteBackLabelTemplate } from 'mdast-util-to-hast/lib/footer.js';
