import { ClassNameGeneratorOption, ClassNamesUtil } from "antd-style/lib/types";
 ...
 * @param options
 */
export declare const createCSS: (cache: EmotionCache, options: ClassNameGeneratorOption) => {
    css: {
